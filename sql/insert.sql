...
당신은 별난 사람이 아니라 별 같은 사람이', sysdate);
insert into album(abseq, atseq, title, img, content, pdate) values(album_seq.nextval, 3, '가로수 그늘 아래 서면', 'https://image.bugsm.co.kr/album/images/500/80216/8021690.jpg', '명곡이다 진짜', sysdate);
insert into album(abseq, atseq, title, img, content, pdate) values(album_seq.nextval, 4, 'The Fifth Season', 'https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/99c08eac-1777-4459-81b0-341be2da5190/dd6iqpj-3f5eda2d-b966-446b-8430-4c34e53c7056.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1cm46YXBwOiIsImlzcyI6InVybjphcHA6Iiwib2JqIjpbW3sicGF0aCI6IlwvZlwvOTljMDhlYWMtMTc3Ny00NDU5LTgxYjAtMzQxYmUyZGE1MTkwXC9kZDZpcXBqLTNmNWVkYTJkLWI5NjYtNDQ2Yi04NDMwLTRjMzRlNTNjNzA1Ni5qcGcifV1dLCJhdWQiOlsidXJuOnNlcnZpY2U6ZmlsZS5kb3dubG9hZCJdfQ.bDyj27Y3ogDb_1srZP8QcGyFt_5D3I57S6tfRUSO-sM', '괜찮은듯', sysdate);	
-- music
