...
-- artist
insert into artist(atseq, name, groupyn, gender, gseq, img, description) values(artist_seq.nextval, 'Ed Sheeran', 'N', 'M', 2, 'https://images.indulgexpress.com/uploads/user/imagelibrary/2019/3/26/original/EdSheeran.jpg', '아티스트 소개');
...
insert into artist(atseq, name, groupyn, gender, gseq, img, description) values(artist_seq.nextval, '오마이걸', 'Y', 'F', 3, 'https://pbs.twimg.com/profile_images/1252284630335582208/SJheEDPM_400x400.jpg', '7인조 걸그룹');
-- album
