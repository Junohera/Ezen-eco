...
public class ArtistValidator implements Validator{
	...
	public void validate(Object target, Errors errors) {
		...
		if (dto.getGender() == null || dto.getGender().isEmpty()) errors.rejectValue("gender", "gender", "성별을 고르세요");
		if (dto.getGseq() == 0) errors.rejectValue("gseq", "genre", "장르는 필수입니다.");
		if (dto.getDescription() == null || dto.getDescription().trim().isEmpty()) errors.rejectValue("description", "description", "본문은 필수입니다.");
	}
